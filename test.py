    ...
    for label_val, label_name in labels.items():
        ...
        with torch.no_grad():
            ...
            for i, sample in enumerate(test_loader):
                ...
                if _config['dataset'] == 'SABS':
                    query_label = query_label[:, :, 1:, 1:]
                ...
                for sub_chunck in range(_config['n_part']):  # n_part = 3
                    ...
                    for i in range(query_image_s.shape[0]):
                        support_image_ss, support_mask_ss = image_enhance.Support_Enhance([support_image_s], [support_fg_mask_s])
                        _pred_s, _, _ = model([support_image_s], [support_fg_mask_s], [support_image_ss[0]], support_mask_ss, [query_image_s[[i]]],
