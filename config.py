...
def cfg():
    ...
    ## dataset
    dataset = 'CHAOST2'#'CHAOST2'  # i.e. abdominal MRI - 'CHAOST2'; cardiac MRI - CMR
    ...
    if dataset == 'CHAOST2':
        ...
        reload_model_path = '/opt/data/private/UPRE-Net/runs/UPRE-Net_train_CHAOST2_cv0/1/snapshots/30000.pth'
        n_sv = 5000
    elif dataset == 'CMR':
        test_label = [1, 2, 3]
        reload_model_path = ''
    ...
    ignore_label = 255
    print_interval = 100
    save_snapshot_every = 6000
    max_iters_per_load = 3000  # epoch size, interval for reloading the dataset
    # which_aug = 'sabs_aug' 
